...
export default function Collection() {
    ...
    const styles = {
        ...
        leftImageContainer: '',
        leftImage: 'object-cover w-[300px] h-[300px] object-top',
        contentContainer: 'flex flex-col text-center md:text-start place-items-center md:place-items-start gap-[2rem]',
        titleContainer: '',
        title: 'font-[700] capitalize text-[3.75rem]',
        subTitleContainer: '',
        subTitle: 'font-[400] text-[1.125rem] leading-[1.8] pr-4',
        buttonContainer: '',
        button: 'buttonPrimary',
        right: 'relative',
        rightImageContainer: 'flex justify-center absolute top-0 left-0 right-0 z-1',
        rightImage: 'object-cover w-full h-[600px] md:w-[500px] md:h-[650px] object-top relative',
        pinkContainer: 'bg-customPink hidden md:block absolute w-[250px] h-[400px] right-0 z-0 bottom-[7rem]',
        brownContainer: 'bg-customBrown hidden md:block absolute w-[250px] h-[400px] left-0 z-0 bottom-[0rem]',
    }
